...
namespace Validus.FileNet.Api.Controllers
{
    ...
    {
        public const ObjectStore os = ObjectStore.Claims;
        public const DocumentClass dc = DocumentClass.Claims;

        // GET api/claims/00000000-0000-0000-0000-000000000000
        [HttpGet]
        [Route("{id}")]
        ...
        // GET api/claims?policyId=ZZZ0000Z000
        [HttpGet]
        [Route("")]
        ...
        // GET api/claims/download/00000000-0000-0000-0000-000000000000
        // GET api/claims/download/00000000-0000-0000-0000-000000000000?inline=true
        [HttpGet]
        [Route("download/{id}")]
